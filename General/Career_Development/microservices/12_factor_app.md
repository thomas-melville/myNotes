...
if an "app" has multiple codebases then it's a distributed system and each component within the system is an app which compliess with 12 factor app
...
env vars are granular controls. orthogonal to other env vars
...
* This makes it easy to scale out the number of processes using a platform tool, kubernetes, ...
